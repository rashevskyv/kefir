...
"C:\Program Files\7-Zip\7z.exe" a -tzip -mx9 -r0 -ssw -xr!010000000007E51A %reldir%\atmo.zip %bd%\atmo\*
"C:\Program Files\7-Zip\7z.exe" a -tzip -mx9 -r0 -ssw -xr!sys-con %reldir%\atmo.zip %bd%\atmo\* 
"C:\Program Files\7-Zip\7z.exe" a -tzip -mx9 -r0 -ssw -xr!.overlays %reldir%\atmo.zip %bd%\atmo\* 
