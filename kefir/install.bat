...
if exist "%sd%:\config\uberhand" (RD /s /q  "%sd%:\config\uberhand")
...
if not exist "%sd%:\switch\.packages\package.ini" (del "%sd%:\switch\.packages\config.ini") 	
if exist "%sd%:\switch\.packages\Settings\config.ini" (del "%sd%:\switch\.packages\Settings\config.ini")
if exist "%sd%:\switch\.packages\Settings\Advanced" (RD /s /q "%sd%:\switch\.packages\Settings\Advanced")
if exist "%sd%:\switch\.packages\Settings\Fan Control\config.ini" (del "%sd%:\switch\.packages\Settings\Fan Control\config.ini")
if exist "%sd%:\switch\.packages\Settings\Fan Control\Custom\config.ini" (del "%sd%:\switch\.packages\Settings\Fan Control\Custom\config.ini")
if exist "%sd%:\switch\.packages\Software\config.ini" (del "%sd%:\switch\.packages\Software\config.ini")
if exist "%sd%:\switch\.packages\Software\DBI\config.ini" (del "%sd%:\switch\.packages\Software\DBI\config.ini")
if exist "%sd%:\switch\.packages\Software\DBI\Fan Translations\config.ini" (del "%sd%:\switch\.packages\Software\DBI\Fan Translations\config.ini")
if exist "%sd%:\switch\.packages\Theme\config.ini" (del "%sd%:\switch\.packages\Theme\config.ini")
if exist "%sd%:\switch\.packages\Translate Interface\config.ini" (del "%sd%:\switch\.packages\Translate Interface\config.ini")
...
if exist "%sd%:\switch\sphaira" (RD /s /q "%sd%:\switch\sphaira")
...
if exist "%sd%:\switch\appstore.nro" (del "%sd%:\switch\appstore.nro")
if exist "%sd%:\switch\appstore\appstore.nro" (del "%sd%:\switch\appstore\appstore.nro")
...
if exist "%sd%:\switch\sphaira\sphaira.nro" (del "%sd%:\switch\sphaira\sphaira.nro")
if exist "%sd%:\switch\sphaira.nro" (del "%sd%:\switch\sphaira.nro")
...
if exist "%sd%:\switch\kefirupdater.nro" (del "%sd%:\switch\kefirupdater.nro")
if exist "%sd%:\switch\kefir-updater.nro" (del "%sd%:\switch\kefir-updater.nro")
...
if exist "%sd%:\games\hbgShop*.nsp" (del "%sd%:\games\hbgShop*.nsp")
if exist "%sd%:\games\Tinfoil*.nsp" (del "%sd%:\games\Tinfoil*.nsp")
if exist "%sd%:\games\hbmenu_[0104444444440000].nsp" (del "%sd%:\games\hbmenu_[0104444444440000].nsp")
...
if exist "%sd%:\switch\.packages\Settings" (RD /s /q "%sd%:\switch\.packages\Settings")
if exist "%sd%:\switch\.packages\Software" (RD /s /q "%sd%:\switch\.packages\Software")
if exist "%sd%:\switch\.packages\Theme" (RD /s /q "%sd%:\switch\.packages\Theme")
if exist "%sd%:\switch\.packages\Translate Interface" (RD /s /q "%sd%:\switch\.packages\Translate Interface")
if exist "%sd%:\switch\.packages\package.ini" (del "%sd%:\switch\.packages\package.ini")
if exist "%sd%:\switch\.packages\config.ini" (del "%sd%:\switch\.packages\config.ini")
