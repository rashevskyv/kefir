...
* Карта памяти 
* Хост с подготовленным пейлоадом и возможность поджключить к нему Switch (например, если хост ПК, понадобится кабель USB type C)
...
* Использовать [замыкатель, распечатанный на 3D-принтере](https://www.thingiverse.com/thing:2877484){:target="_blank"} (вы можете купить уже готовый: <a href="https://www.olx.ua/obyavlenie/nintendo-switch-rcm-jig-IDAWSI6.html" target="_blank"><img src="/images/ua.png" alt="Украина" style="vertical-align: baseline !important;"></a>, <a href="http://vk.com/tehno_3d" target="_blank"><img src="/images/ru.png" alt="Россия" style="vertical-align: baseline !important;"></a>)
...
Донгл необходимо зарядить комплектным кабелем, либо вставить во **включённую** приставку приставку
{: .notice--warning}
...
1. Вставьте донгл в консоль
	* Для запуска hekate она должна быть [прошита в донгл](r4#прошивка-донгла){:target="_blank"}. hekate запустится сразу, как только вы вставили донгл в консоль в режиме RCM. Если ваша цель была запуск hekate - вы её достигли, можете доставать [замыкатель](#замыкатель) 
