...
header:	
  ...
  overlay_filter: 0.5
  caption:
excerpt: 'Полное руководство по прошивке Nintendo Switch<br />**Последнее изменение:** 19 декабря'
---
...
+ После каждого полного выключения приставки вам нужно будет запускать взлом заново. [Специальный {% include abbr/dongle.txt abbr="донгл" %}](http://3dscfw.olx.ua){:target="_blank"} или [модчип](http://3dscfw.olx.ua){:target="_blank"} существенно упростят вам жизнь (только в случае наличия аппаратной уязвимости)
