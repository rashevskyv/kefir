...
header:	
  ...
  overlay_filter: 0.5
  caption:
excerpt: 'Полное руководство по прошивке Nintendo Switch<br />**Последнее изменение:** 20 мая'
---
...
+ В любой момент вы можете получить бан, даже если ваша цель всего лишь запуск Homebrew
	...
	+ Никогда не выходите онлайн на официальной прошивке. Используйте [Atmosphere](atmo){:target="_blank"} для этого - она умеет подтирать за собой логи.
