...
Прежде чем начать, как начать, удалите все активные точки доступа на вашей консоли
...
Если вам всё-таки нужен интернет настолько, что вы готовы рискнуть, пропишите DNS у активной точки доступа: 
...
# Следующий шаг: [Выбор кастомной прошивки](launch-cfw) 
{: .notice--success}