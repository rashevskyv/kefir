...
Если по какой-то причине у вас возникают проблемы при установке по USB на вашей системе, воспользуйтесь [старым методом установки с помощью NS USB Loader](games-old){:target="_blank"}. Этот метод доступен для всех ОС. 
{: .notice--warning}
