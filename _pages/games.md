...
Вы можете скинуть игры в формате `.nsp` , `.nsz`, `.xci`, подключить носитель к консоли через OTG-кабель, или в док-станцию и устанавливать игры напрямую с носителя! Носительн должн быть отформатирован в файловую систему **exFAT**
{: .notice--warning}
