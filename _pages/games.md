...
1. **Для пользователей 7.0.0 и выше**
	1. Запустите "**Tinfoil**"
		* В свежем паке есть два "**Tinfoil**". Используйте тот, версия которого 1.0.0 и есть яркая иконка
	...
	1. После завершения установки вернитесь на домашний экран, нажатием кнопки (HOME)
1. **Для пользователей 6.2.0 и ниже**
	1. Выполните [подготовительные работы](#подготовительные-работы){:target="_blank"}, если ещё не сделали этого
	1. Запустите "**Tinfoil**"
