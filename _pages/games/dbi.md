...
DBI, начиная с версии 39, умеет устанавливать игры в формате XCI как с карты памяти, так и по USB. Установка таких игр ничем не отличается от установки NSP. 

# Установка игр с карты памяти

Игры, дополнения, DLC можно устанавливать в произвольном порядке. Всё, что имеет формат `.nsp` или `.xci` устанавливается одинаково по этой инструкции
