...
Это ОЧЕНЬ сложный и комплексный метод. ОБЯЗАТЕЛЬНО [сделайте бекап](backup-nand){:target="_blank"} своей текущей прошивки до того, как начнете выполнениеэтого метожа. ОБЯЗАТЕЛЬНО. 
{: .notice--danger}
...
# Следующий шаг: [Обновление прошивки ддо 6.2](update-to-latest) 
{: .notice--success}