...
Пользователи прошивки 5.0.1 и выше, просто обновите прошивку через настойки приставки и переходите к [следующему шагу](launch-cfw) 
...
1. Отформатируйте карту, которую собираетесь использовать в FAT32 стандартными средствами вашей ОС, если она в другой файловой системе
	...
	* Пропустите этот пункт, если ваша карта в exfat и прекрасно при этом работает
