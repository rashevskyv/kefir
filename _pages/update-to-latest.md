...
1. Запустите [кастомную прошивку](launch-cfw){:target="_blank"}
	...
	* Если версия вашего системного ПО ниже, чем 3.0.0 включительно и у вас не запускается кастом: 
		...
		1. Вставьте карту памяти обратно в Switch и запустите прошивку через пейлоад `payload.bin` из пака
		1. После запуска прошивки, действуйте по инструкции ниже
