...
1. Запустите **ChoiDujourNX**
	* Если при запуске программы происходит ошибка, пробуйте запустить её в режиме тайтла. Если и так запускали в режиме тайтла, пробуйте в режиме апплета. Подробнее о режимах запуска [тут](hbl){:target="_blank"}
