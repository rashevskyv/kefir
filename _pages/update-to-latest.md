...
1. Перейдите в меню, соответствующее прошивке с которой вы обновлялись:
	* при обновлении с **1.0.0 по 3.0.0** включительно выберите **Launch firmware** -> **CFW + nogc** или **Launch firmware** -> **ReiNX + nogc**
	* при обновлении с **4.0.0** и выше выберите **Launch firmware** -> **CFW** или **Launch firmware** -> **ReiNX**
