...
Для удобства использования взлома в данный момент лучшим решением будет обновить прошивку до версии **{% include /vars/sys_version.txt %}**. 
...
1. Запустите [кастомную прошивку](launch-cfw){:target="_blank"}
	* Если у вас прошивка версии 1.0.0 и вы испытываете проблемы с запуском прошивки или **ChoiDujourNX** (ниже по тексту), то вам нужно запустить прошивку через hekate (чтобы войти в hekate, удерживайте (VOL-) dj время появления заставки), выбрав **"Launch"** -> **"Atmosphere DEBUG"**.
