...
1. Запустите **любую** [кастомную прошивку](launch-cfw){:target="_blank"}
	* Если вы обновляетесь с прошивки 1.0.0, то вам необходимо запускать [RajNX](rajnx){:target="_blank"} и выбирать "**RajNX CFW - Firmware 1.0.0 only**"
...
1. Выберите "**5.1.0 (exFAT)**" и нажмите "**Select firmware**"
1. Нажмите "**Start installation**" для начала установки прошивки
1. После окончания установки нажмите "**Reboot**", "**Shutdown now!**"

## Часть V - Активация AutoRCM

Можете пропустить эту часть если до начала обновления вы ни разу не запускали ни одну кастомную прошивку! 
{: .notice--info}
