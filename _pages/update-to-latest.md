...
Пользователи прошивки 5.0.1? просто обновите прошивку через настойки приставки. 
...
1. Запустите **любую** [кастомную прошивку](launch-cfw){:target="_blank"}
	* Если вы обновляетесь с прошивки 1.0.0, то вам необходимо запускать [RajNX](rajnx){:target="_blank"}
