...
1. Запустите [ReiNX](reinx){:target="_blank"} или [SX OS](sxos){:target="_blank"}
	* Если прошивка не запускается, или в HBL не отображаются имеющиеся приложения, запустите ["**RajNX Debug**"](rajnx){:target="_blank"}
...
Вариант для внимательных и самоуверенных. Вы можете обновить прошивку и обычным официальным способом, если вам не нужно сберечь предохранители и вы не сильно переживаете из-за возможности получить бан. А ещё вы можете случайно обновиться на прошивку, на которой ещё не работают кастомы. Например, 29.08 ночью вышла прошивка 6.1.0, которую ещё никто не поддерживает.  
