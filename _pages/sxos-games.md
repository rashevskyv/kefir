...
# Использование SX Installer

Не используйте SX Installer ни для чего, кроме работы с USB-носителем. Программа давно не обновлялась и часть её функций могут работать некорректно!
Используйте [tinfoil](tinfoil)!
