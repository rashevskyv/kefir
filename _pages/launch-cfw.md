...
Если версия вашего системного ПО уже {% include /vars/sys_version.txt %}, то привяжите аккаунт к приставке. Для этого зайдите в eSHOP и создайте новый аккаунт, если он еще не создан, либо привяжите уже имеющийся. 
