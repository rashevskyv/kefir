...
**О:** Можно прошить приставку с любой прошивкой, если она прошиваемая в принципе
...
**О:** На прошитой приставке выключите консоль, достаньте картридж, запустите [hekate](fusee-gelee){:target="_blank"}, выберите "**Launch**" -> "**More configs** -> "**ваша_прошивка**" и сразу после выбора зажмите (vol+) + (vol-). Вы попадёте в меню восстановления в котором будет отображаться текущая версия прошивки. После перезагрузки приставки скачанное обновление удалиться. 
