...
**О:** Перезагрузите приставку через меню электропитание (удежание кнопки (POWER) -> **Параметры электропитания** -> **Перезагрузка**), чтобы попасть в {% include abbr/hekate.txt abbr="hekate" %}. Оттуда вы сможете, например, безопасно извлечь карту из приставки. 
