...
**О:** Нет, новые ревизии выпускаются пропатченными и не позволяют использовать эксплоит для запуска кастома. Проверить прошивается ли ваш свитч или нет можно на [этой странице](https://ismyswitchhackable.github.io/){:target="_blank"}
...
### **В:** Почему после вsrk.xtybz приставка включается\входит в RCM? 
