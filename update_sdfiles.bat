...
ECHO ==================================================================
ECHO.
ECHO    На новых версиях Atmosphere для входа в Homebrew Menu нужно 
ECHO               запускать Альбом удерживая кнопку R
ECHO.
ECHO          Если ваша прошивка 8.0.0, вам нужно зайти в опции
ECHO              (буква O на следующем экране) и выбрать её
ECHO.
ECHO      Нажмите R, затем Enter, если вы знакомились с написанным
ECHO                      и готовы продолжить
ECHO.       
ECHO ------------------------------------------------------------------
ECHO.
...
for %%A in ("R" "r" "К" "к") do if "%st%"==%%A (GOTO START)
for %%A in ("R" "r" "К" "к") do if "%st%" neq %%A (GOTO disclaimer)
